...
/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 /; /!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 /; /!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' /; /!40111 SET @OLD_SQL_NOTES=@@SQL_NOTES, SQL_NOTES=0 */; /*Table structure for table edu_chapter */
...
CREATE TABLE edu_course_description ( id char(19) NOT NULL COMMENT '课程ID', description text COMMENT '课程简介', gmt_create datetime NOT NULL COMMENT '创建时间', gmt_modified datetime NOT NULL COMMENT '更新时间', PRIMARY KEY (id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='课程简介';

/*Data for the table edu_course_description */

insert into edu_course_description(id,description,gmt_create,gmt_modified) values ('1104870479077879809','
...
CREATE TABLE edu_teacher ( id char(19) NOT NULL COMMENT '讲师ID', name varchar(20) NOT NULL COMMENT '讲师姓名', intro varchar(255) NOT NULL COMMENT '讲师资历,一句话说明讲师', career text COMMENT '讲师简介', level int(10) unsigned NOT NULL COMMENT '头衔 1高级讲师 2首席讲师', avatar varchar(255) DEFAULT NULL COMMENT '讲师头像', sort int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序', is_deleted tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '逻辑删除 1（true）已删除， 0（false）未删除', gmt_create datetime NOT NULL COMMENT '创建时间', gmt_modified datetime NOT NULL COMMENT '更新时间', PRIMARY KEY (id), KEY idx_name (name) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='讲师';
